...
// Brute force attempt as baseline.
console.log('Attempt 1');
start1 = Date.now();
console.log(naiveLoop(list));
end1 = Date.now();
console.log('Time taken: ' + (end1-start1).toString());

// ----------------------

// Minor optimisations - o(nlogn)
...
evenRes = naiveLoop(evens);
if (evenRes !== 0) {
    console.log(evenRes);
}
else {
    console.log(naiveLoop(odds));
}

end2 = Date.now();
console.log('Time taken: ' + (end2-start2).toString());